...
async def run_test():
    ...
    try:
        ...
        # -> Send GET request to /products/{valid_id} API endpoint with a valid product ID
        await page.goto('http://localhost:3000/products/1', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Send GET request to /products/{invalid_id} API endpoint with an invalid product ID
        await page.goto('http://localhost:3000/products/9999', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Check HTTP response status code for GET /products/9999 API request to confirm 404 Not Found
        await page.goto('http://localhost:3000/api/products/9999', timeout=10000)
        await asyncio.sleep(3)
