...
async def run_test():
    ...
    try:
        ...
        # -> Add Codemify Backpack to cart with quantity 1
        frame = context.pages[-1]
        # Click 'Add to Cart' button for Codemify Backpack with price $29.99
        elem = frame.locator('xpath=html/body/div/div/main/div/ul/li/div[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click on Cart button to view cart details and total price
        frame = context.pages[-1]
        # Click Cart button to view cart details and total price
        ...
        frame = context.pages[-1]
        # Click 'Remove' button to remove Codemify Backpack from cart
